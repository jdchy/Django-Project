...
from .models import RegistrationData, Book
...
class RegistrationForm(forms.Form):
	...
	phone = forms.CharField(max_length=100,widget=forms.NumberInput(attrs={'class':'form-control','placeholder':'Phone Number'}))
